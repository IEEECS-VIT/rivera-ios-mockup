...
class settingsCollectionViewController: UICollectionViewController {
    ...
    private var settingsSet: [Settings] = [ Settings(settingsName: "candle", settingsImage: "Wishlist"),
                                            Settings(settingsName: "ghost", settingsImage: "FeedBack"),
                                            Settings(settingsName: "cat", settingsImage: "Contact"),
                                            Settings(settingsName: "dribble", settingsImage: "Developers"),
                                            Settings(settingsName: "ghost", settingsImage: "Licenses"),
                                            Settings(settingsName: "cat", settingsImage: "Login")
